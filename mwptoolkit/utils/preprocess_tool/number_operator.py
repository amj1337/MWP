...
def turkish_word_2_num(word_list, fraction_acc=2):
    """
    Convert Turkish words to numbers in the given word list.

    :param word_list: List of words to process.
    :param fraction_acc: Accuracy of the fraction.
    :return: List of words with numbers converted from words.
    """
    word2num = {
    ...
    for word in word_list:
        if word.lower() in word2num:
            num_list.append(str(word2num[word.lower()]))
        else:
